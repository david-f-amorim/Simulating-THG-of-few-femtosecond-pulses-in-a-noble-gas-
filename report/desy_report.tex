...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{im/profile_prop_Ar}
...
\centering
 \begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth]{im/spec_comp_Ar_150mw_2.5scale_0.4bar}
\caption{Cell and surroundings}\label{im:dens_whole}
\end{subfigure}
 \begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth]{im/spec_comp_Ne_400mw_2.5scale_2.0bar}
\caption{Central interaction region}\label{im:dens_cent}
\end{subfigure}
\caption{Comparison of the \textit{COMSOL}-generated gas density distributions of the new and old fused silica chip as well as the gradient model.}\label{im:dens}
\end{figure}
