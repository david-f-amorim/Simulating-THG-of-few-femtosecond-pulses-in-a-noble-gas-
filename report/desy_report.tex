...
\begin{abstract}
Ultrashort ultraviolet (UV) laser pulses can be produced via nonlinear optical processes in noble gasses using few-femtosecond near-infrared (NIR) input pulses. The theoretical modelling of these effects can be challenging, however, as many common pulse propagation equations are based on approximations that do not hold for ultrashort pulses. 
