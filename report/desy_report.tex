...
\mathcal{L}(\omega, z) = i \left( \beta(\omega, z) - \frac{\omega}{z} \right) - \frac{1}{2} \alpha (\omega,z),
\end{equation}
...
I want to thank Josina Hahne for the supervision of the project and all of her support, as well as Vincent Wanie for his additional guidance. I also want to thank Chris Brahms for providing help with \textit{Luna.jl} as well as Olaf Behnke and Andreas Przystawik for organising the DESY Summer Student programme.  
