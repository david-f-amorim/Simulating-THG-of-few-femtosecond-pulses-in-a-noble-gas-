...
With further modifications and extensions, the simulations presented here could form the basis of a robust framework to complement experimental results and aid experimental design by exploring the effects of changing various experimental parameters.  
\end{abstract}
]
...
\centering
 \begin{subfigure}{0.49\textwidth}
    ...
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{im/new_chip_foto_edited}
   \caption{}
    \end{subfigure}   
    \begin{subfigure}{0.49\textwidth}
   ...
   \caption{}
    \end{subfigure}   
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{im/old_cell_edited}
   \caption{}
    \end{subfigure}
\caption{The fused silica chip and pumping system with which the gas is confined. The red line in Figure [subfigure b] indicated the path of the laser beam, whereas the coloured boxes highlight the gas inlet and pumping stages. The gas is pumped in through the blue tube visible in [b] while the grey tubes form the differential pumping system. ADD IMAGE CREDITS..WRITE EXTENDED CAPTION}
\end{figure*}

\section{Simulation Results}

MENTION GRADIENT MODEL... CENTRAL REGION.... FOCUS ON NE AND AR AT SPECIFIC PRESSURES.... INPUT BEAM MODELLED AS A GAUSSIAN IN SPACE BUT WITH MEASURED TEMPORAL PROFILE...

\subsection{Comparison with Experiment}

\textcolor{red}{mention energy and pressure mismatch; mention saturation; mention redshift...; mention how these differences could be due to effects outside central region}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{im/energies_Ar_150mw_2.5scaled_grad}\label{im:sim_v_measured}
\caption{Simulated and experimental values for normalised UV output energies at different central pressures using Argon at 150mW input beam power. Note that the pressure axis of the simulated data has been rescaled.}
\end{figure}

\textcolor{red}{test image}
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{im/spec_comp_Ar_150mW_2.5scale_0.4bar}\label{im:sim_v_measured}
\caption{Simulated and experimental values for the UV output spectrum  using Argon at 150mW input beam power and 0.4bar central pressure. Note that the pressure of the simulated data has been rescaled.}
\end{figure}
...
\centering
 \begin{subfigure}{0.5\textwidth}
    ...
    \caption{simulation}
    \end{subfigure}   
\caption{UV output spectra at different central pressures. Generated with Argon at 150mW input beam power. Note that the pressure axis of the simulated data has been rescaled.}
\end{figure}
...
\centering
 \begin{subfigure}{0.24\textwidth}
        \includegraphics[width=\textwidth]{im/Ar_prelim_sim_v_measured}
    \caption{$t=0$}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \includegraphics[width=\textwidth]{im/Ar_prelim_sim_v_measured}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{im/Ar_prelim_sim_v_measured}\label{im:sim_v_measured}
\caption{Measured and simulated UV output spectrum of Argon at 150mW input beam power and 0.4bar central pressure.}
\end{figure}
